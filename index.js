const contentLetterSrart_actived = "Hôm nay là một ngày đặc biệt và chính em cũng vậy!" //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc mừng sinh nhật! Đôi khi cuộc sống đưa ta vào những thử thách, nhưng đó cũng là cơ hội để chúng ta phát triển và trưởng thành. Phải luôn mạnh mẽ bước về phía trước nhớ chưa hả! Cô bé ngốc" //Nội dung của bức thư
